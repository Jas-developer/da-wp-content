...
<body <?php body_class(); ?>>
    ...
    <div id="accessibility-shortcuts" class="bg-danger">
        <ul>
            ...
            <li style="color:red;"><a href="<?php echo $govph_acc_link_home; ?>" accesskey="h">Home</a></li>
            <?php endif; ?>
...
Press esc, or click the close the button to close this dialog box.
    ...
    <div class="off-canvas-wrapper">
        <div class="off-canvas-wrapper-inner" data-off-canvas-wrapper>
            ...
            <div id="main-nav" style=" background-color:green; ">
                <div class="row">
                    <div class="large-12 columns" style="padding-top:2px; padding-bottom:2px;">
                        <nav class="top-bar-left">
                            <ul class="dropdown menu gap-lg-3" data-dropdown-menu>
                        ...
                        <nav class="top-bar-right h-100 d-flex justify-content-center align-items-center w-25">

                            <ul class="dropdown menu w-100" data-dropdown-menu>
                                ...
                                <li class="search w-100  right"><?php get_search_form(); ?></li>
                                <?php endif ?>
                                <li>
			...
			?>
                ...
                <!-- masthead -->
                <header class="container-masthead bg-white">
                    <!-- 
                      # only show the masthead when user is_home();
                      # hide if user not home
                    -->
                    <?php if(is_front_page()){ ?>
                        <!-- 
                          #mast head will go here 
                        -->
        ...
        <script>
          function updateTime() {
            const now = new Date();
                    ...
                    document.getElementById('wp-realtime').textContent =
