...
function govph_displayoptions( $options ){
  ...
  switch ($options) {
    case 'govph_logo_enable':
      return (isset($option['govph_disable_search']) && $option['govph_logo_enable'] == 1);
      break;
    ...
    case 'govph_logo':
      ...
      '<div id="textlogo-wrapper">
        <div id="textlogo-image"><img alt="'.(isset($option['govph_agency_enable']) && $option['govph_agency_name']).' Official Logo" src="'.$logo_image.'" height="100px" width="100px"/></div>
        <div id="textlogo-inner-wrapper">
          <div id="agency-heading">Republic of the Philippines</div>
          <div id="agency-name">'.(isset($option['govph_agency_enable']) && $option['govph_agency_name']).'</div>
          <div id="agency-tagline">'.(isset($option['govph_agency_enable']) && $option['govph_agency_tagline']).'</div>
        </div>
       </div>' ;
      echo $addLogo;
      break;
...
// Check if $option is an array and the key is set before comparing
elseif ((is_array($option) && isset($option['govph_slider_fullwidth']) && $option['govph_slider_fullwidth'] != 'true') || is_active_sidebar('banner-section-1') || is_active_sidebar('banner-section-2')) {
        echo '</div>';
      }
      break;
